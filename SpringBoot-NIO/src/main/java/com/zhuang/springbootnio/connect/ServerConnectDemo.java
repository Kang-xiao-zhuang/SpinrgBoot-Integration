package com.zhuang.springbootnio.connect;
...
public class ServerConnectDemo {
    public static void main(String[] args) throws Exception {
        ServerConnectDemo serverConnectDemo = new ServerConnectDemo();
        serverConnectDemo.sendDatagram();
        serverConnectDemo.receiveDatagram();
        serverConnectDemo.testConnect();
    }
